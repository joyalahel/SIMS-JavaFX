...
-- Generated on: Fri Nov 28 10:05:12 EET 2025
...
INSERT INTO users (id, username, password, role, full_name, email, created_date, is_active) VALUES ('7', 'a001', 'password123', 'student', 'Joy AlAhel', 'joyelahel@gmail.com', '2025-11-22 11:50:01.45', '1');
INSERT INTO users (id, username, password, role, full_name, email, created_date, is_active) VALUES ('8', 'a002', 'password123', 'student', 'Maria Makary', 'mariamakary@gmail.com', '2025-11-22 11:55:57.28', '1');
INSERT INTO users (id, username, password, role, full_name, email, created_date, is_active) VALUES ('12', 'i001', 'password123', 'instructor', 'Mariam Harfouch', 'mariamharfouch@gmail.com', '2025-11-22 14:28:29.327', '1');
INSERT INTO users (id, username, password, role, full_name, email, created_date, is_active) VALUES ('13', 'a003', 'password123', 'student', 'Joe Rohban', 'joerohban@gmail.com', '2025-11-22 15:12:52.137', '1');
INSERT INTO users (id, username, password, role, full_name, email, created_date, is_active) VALUES ('14', 'i002', 'password123', 'instructor', 'Georges Abdallah', 'abdallahgeorges@gmail.com', '2025-11-22 15:13:31.96', '1');
INSERT INTO users (id, username, password, role, full_name, email, created_date, is_active) VALUES ('1002', 'a004', 'password123', 'student', 'Tonio Jreige', 'toniojreige@gmail.com', '2025-11-23 10:27:01.567', '1');
INSERT INTO users (id, username, password, role, full_name, email, created_date, is_active) VALUES ('1004', 'i003', 'password123', 'instructor', 'Serena Dib', 'serenadib@gmail.com', '2025-11-23 13:35:17.34', '1');
-- 8 records backed up
...
INSERT INTO enrollments (enrollment_id, student_id, course_id, grade, status) VALUES ('2', 'A001', 'C002', '90.00', 'enrolled');
